...
export const algorithms: Record<string, Algorithm> = {
  "bubble-sort": {
    ...
    resources: [
      ...
      {
        title: "Bubble Sort Algorithm - Programiz",
  ...
  "quick-sort": {
    ...
    description:
      'Quick Sort is an efficient, recursive divide-and-conquer approach to sorting an array. It works by selecting a "pivot" element and partitioning the other elements into two sub-arrays according to whether they are less than or greater than the pivot.',
    codeExamples: {
...
function partition(arr, low, high) {
  ...
  "merge-sort": {
    ...
    resources: [
      ...
      {
        title: "Merge Sort Algorithm - Programiz",
    ...
    description:
      "Merge Sort is an efficient, stable sorting algorithm that makes use of the divide and conquer strategy. It works by dividing the unsorted list into n sublists, each containing one element, then repeatedly merging sublists to produce new sorted sublists until there is only one sublist remaining.",
    codeExamples: {
      c: `
#include <stdio.h>
#include <stdlib.h>
...
def merge(left, right)
  ...
  "insertion-sort": {
    ...
    resources: [
      ...
      {
        title: "Insertion Sort Algorithm - Programiz",
        url: "https://www.programiz.com/dsa/insertion-sort",
      },
      {
        title: "Insertion Sort Visualization - VisuAlgo",
        url: "https://visualgo.net/en/sorting",
      },
    ],
    description:
  ...
  "selection-sort": {
    ...
    resources: [
      ...
      {
        title: "Selection Sort Algorithm - Programiz",
        url: "https://www.programiz.com/dsa/selection-sort",
      },
      {
        title: "Selection Sort Visualization - VisuAlgo",
        url: "https://visualgo.net/en/sorting",
      },
    ],
    description:
      "Selection Sort is a simple sorting algorithm that repeatedly selects the smallest element from the unsorted portion of the list and places it at the beginning of the sorted portion of the list.",
    codeExamples: {
  ...
  "heap-sort": {
    ...
    resources: [
      ...
      {
        title: "Heap Sort Algorithm - Programiz",
        url: "https://www.programiz.com/dsa/heap-sort",
      },
      {
        title: "Heap Sort Visualization - VisuAlgo",
        url: "https://visualgo.net/en/sorting",
      },
    ],
    description:
